###########################################################################
## Makefile generated for Simulink model 'inner'. 
## 
## Makefile     : inner.mk
## Generated on : Thu Nov 20 13:08:41 2014
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/inner.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/simon/Documents/GitHub/LEGO-segway/matlab
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = inner_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = inner_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/inner.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/inner_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=inner -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/inner_grt_rtw/inner.c $(START_DIR)/inner_grt_rtw/inner_data.c $(START_DIR)/inner_grt_rtw/rtGetInf.c $(START_DIR)/inner_grt_rtw/rtGetNaN.c $(START_DIR)/inner_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = inner.obj inner_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
